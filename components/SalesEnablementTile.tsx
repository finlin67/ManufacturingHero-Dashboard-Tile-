...
const CountingNumber = ({ value, prefix = '', suffix = '', duration = 2 }) => {
  ...
  // Format helper
  const formatted = numericValue % 1 !== 0 ? displayValue.toFixed(1) : Math.floor(displayValue);
...
export default function SalesEnablementTile() {
  ...
  return (
    ...
    >
      ...
      {/* Center Badge (Absolute Centered) */}
